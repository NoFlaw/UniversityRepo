...
namespace University.DAL.Init
{
    class UniversityInitializer : DropCreateDatabaseIfModelChanges<UniversityContext>
    {
        protected override void Seed(UniversityContext context)
        {
            ...
            foreach (Enrollment e in from e in enrollments
                     let enrollmentInDataBase = 
                     context.Enrollments.SingleOrDefault(s => s.Student.Id == e.StudentId && s.Course.CourseId == e.CourseId)
                     where enrollmentInDataBase == null
                     select e)
            {
